...
void Attys_scope::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Attys_scope *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Attys_scope::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_Attys_scope.data,
    qt_meta_data_Attys_scope,
    qt_static_metacall,
    nullptr,
    nullptr
} };
